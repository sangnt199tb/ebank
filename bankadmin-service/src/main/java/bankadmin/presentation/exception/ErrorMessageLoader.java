...
public class ErrorMessageLoader {
    ...
    public ErrorMessageLoader(){
        try {
            ...
            englishMessage.load(new InputStreamReader(new ClassPathResource("message_admin_en.properties").getInputStream(), charset));
            ...
            vietnameseMessage.load(new InputStreamReader(new ClassPathResource("message_admin_vn.properties").getInputStream(), charset));
