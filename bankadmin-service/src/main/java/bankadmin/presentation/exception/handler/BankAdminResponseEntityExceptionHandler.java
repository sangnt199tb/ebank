package bankadmin.presentation.exception.handler;

import bankadmin.presentation.exception.BankAdminNotFoundException;
import bankadmin.presentation.exception.ErrorHelper;
import bankadmin.presentation.exception.Response;
import bankadmin.presentation.exception.TpbException;
...
public class BankAdminResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(value = {Throwable.class})
    protected ResponseEntity<Response> handlerTpbExp(Throwable ex, WebRequest request){
        HttpHeaders headers = new HttpHeaders();

        if(ex instanceof BankAdminNotFoundException){
            BankAdminNotFoundException notFoundException = (BankAdminNotFoundException) ex;
