package file.presentaion.exception.handler;

import file.presentaion.exception.ErrorHelper;
import file.presentaion.exception.FileNotFoundException;
import file.presentaion.exception.Response;
import file.presentaion.exception.TpbException;
...
public class FileResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Response> handlerTpbExp(Throwable ex, WebRequest request){
        ...
        if(ex instanceof FileNotFoundException){
            FileNotFoundException notFoundException = (FileNotFoundException) ex;
