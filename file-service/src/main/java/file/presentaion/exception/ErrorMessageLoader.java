...
public class ErrorMessageLoader {
    ...
    public ErrorMessageLoader(){
        try {
            ...
            englishMessage.load(new InputStreamReader(new ClassPathResource("message_file_en.properties").getInputStream(), charset));
            ...
            vietnameseMessage.load(new InputStreamReader(new ClassPathResource("message_file_vn.properties").getInputStream(), charset));
