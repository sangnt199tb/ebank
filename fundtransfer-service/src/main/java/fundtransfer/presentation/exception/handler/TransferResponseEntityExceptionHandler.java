package fundtransfer.presentation.exception.handler;


import fundtransfer.presentation.exception.ErrorHelper;
import fundtransfer.presentation.exception.TransferNotFoundException;
import fundtransfer.presentation.exception.Response;
import fundtransfer.presentation.exception.TpbException;
...
public class TransferResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Response> handlerTpbExp(Throwable ex, WebRequest request){
        ...
        if(ex instanceof TransferNotFoundException){
            TransferNotFoundException notFoundException = (TransferNotFoundException) ex;
