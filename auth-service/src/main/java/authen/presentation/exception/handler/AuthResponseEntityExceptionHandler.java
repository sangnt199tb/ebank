package authen.presentation.exception.handler;

import authen.presentation.exception.AuthNotFoundException;
import authen.presentation.exception.ErrorHelper;
import authen.presentation.exception.Response;
import authen.presentation.exception.TpbException;
...
public class AuthResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Response> handlerTpbExp(Throwable ex, WebRequest request){
        ...
        if(ex instanceof AuthNotFoundException){
            AuthNotFoundException notFoundException = (AuthNotFoundException) ex;
