...
public class ErrorMessageLoader {
    ...
    public ErrorMessageLoader(){
        try {
            ...
            englishMessage.load(new InputStreamReader(new ClassPathResource("message_customer_en.properties").getInputStream(), charset));
            ...
            vietnameseMessage.load(new InputStreamReader(new ClassPathResource("message_customer_vn.properties").getInputStream(), charset));
