...
public class ErrorMessageLoader {
    ...
    public ErrorMessageLoader(){
        try {
            ...
            englishMessage.load(new InputStreamReader(new ClassPathResource("message_common_en.properties").getInputStream(), charset));
            ...
            vietnameseMessage.load(new InputStreamReader(new ClassPathResource("message_common_vn.properties").getInputStream(), charset));
